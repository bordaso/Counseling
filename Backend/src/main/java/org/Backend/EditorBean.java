...
public class EditorBean extends SpringBeanAutowiringSupport  {
	...
	private String[] theDates = {"2019-05-26","2019-05-29"};
	
	private int actualPos=theDates.length;
	...
	public String getFinalex() {
		...
		return finalex.toString();
	}
	
	
	public int getLength() {
		
		return theDates.length;
	}
	
	public String getDatex() {
		

		System.err.println(tempPos+" xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
		
		if(tempPos>=actualPos) {
			tempPos=0;
			return null;
		}
		
		return theDates[tempPos++];
	}
	
	
	public void setActPos() {
	    String value = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap().get("param");
	    actualPos=Integer.valueOf(value);
	}
	
	
//	public String getActualPos() {
//		return actualPos;
//	}
	...
	public void setTheDates(String[] theDates) {
